        ...
        **kwargs
        ...
        self.api = apigw.RestApi(
            ...
            default_cors_preflight_options=apigw.CorsOptions(
                allow_origins=["http://localhost:3000"],  # Will add CloudFront later
    ...
    def create_lambda_function(
        ...
        Example:
            lambda_fn = self.create_lambda_function(
                ...
                handler_path="lambda_functions/questions",
        ...
        # Path to Lambda code
        # Goes up from infrastructure/ to backend/ then to handler path
